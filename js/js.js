var curr_date, curr_month, date, curr_year, urlPost, repo, postUrl, fecha, github;
	...
	$(document).ready(function() {
        ...
        mode : "textareas",
        theme : "advanced",
        plugins : "autolink,lists,spellchecker,pagebreak,style,layer,table,save,emotions,inlinepopups,insertdatetime,preview,media,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,template",
